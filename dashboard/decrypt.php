    ...
    <?php include('navmenu.php'); ?>
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-file"></i>Kumpulan E Book</h1>
          </div>
          <div>
            <ul class="breadcrumb">
              <li><i class="fa fa-home fa-lg"></i></li>
              <li><a href="index.php">Dashboard</a></li>
              <li>Kumpulan E Book</li>
            </ul>
          </div>
        </div>
        <div class="row">
                  ...
                  <table id="file" class="table striped">
                    <thead class="bg-primary">
                        <tr>
                          ...
                          <td width="20%"><strong>Nama E Book</strong></td>
                          <td width="20%"><strong>Nama E Book Enkripsi</strong></td>
                          <td width="20%"><strong>Path E Book</strong></td>
                          <td width="15%"><strong>Status E Book</strong></td>
                        ...
                        <?php
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              $a = $data['id_file'];
                              if ($data['status'] == 1) {
                                echo '<a href="decrypt-file.php?id_file='.$a.'" class="btn btn-warning">Buka Kunci</a>';
                              }elseif ($data['status'] == 2) {
                                echo '<a href="history.php" class="btn btn-success">Terbuka</a>';
                              }else {
