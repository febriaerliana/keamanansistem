...
?>
  <head>
    <title> <?php echo $data['fullname']; ?> Kumpulin</title>
    <meta charset="utf-8">
              ...
              <div class="card-body">
                <form class="form-horizontal" method="post" action="encrypt-process.php" enctype="multipart/form-data">
                      <fieldset>
                        ...
                        <div class="form-group">
                          <label class="col-lg-2 control-label" for="inputFile">Tugas</label>
                          <div class="col-lg-4">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-4">
                            <input class="form-control" id="inputPassword" type="password" placeholder="Kunci Tugasmu dengan Password" name="pwdfile" required>
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-lg-2 control-label" for="textArea">Keterangan</label>
                          <div class="col-lg-4">
                            <textarea class="form-control" id="textArea" rows="3" name="desc" placeholder="Keterangan tugas"></textarea>
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-lg-2 control-label" for="textArea"></label>
                          <div class="col-lg-2">
                            <input type="submit" name="encrypt_now" value="Kumpulin" class="form-control btn btn-primary">
                          </div>
                        </div>
                      </fieldset>
                    </form>
