<div class="wrapper">
      <header class="main-header hidden-print"><a class="logo" href="" target="_blank" rel="noopener noreferrer" style="font-size:13pt"><img src="" alt="" srcset=""><strong>MAHNOOR</strong></a>
      ...
      <aside class="main-sidebar hidden-print">
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="materi.php"><i class="fa fa-book"></i><span>Preview E-Book</span></a></li>
            <?php 
            $v = $_SESSION['username'];
            $query = mysqli_query($connect, "SELECT * FROM users WHERE username='$v'");
            $users = mysqli_fetch_array($query);
            if ($users['status'] == 1) {
              echo '<li class="treeview"><a href="#"><i class="fa fa-file-o"></i><span>E-Book </span><i class="fa fa-angle-right"></i></a>
                <ul class="treeview-menu">
                  <li><a href="encrypt.php"><i class="fa fa-circle-o"></i> Tambah E-Book</a></li>
                  <li><a href="decrypt.php"><i class="fa fa-circle-o"></i> Kumpulan E-Book</a></li>
                </ul>
              </li>';
            ...
            <li><a href="history.php"><i class="fa fa-list-alt"></i><span>Download E-Book</span></a></li>
          </ul>
        </section>
      </aside>