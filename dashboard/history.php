    ...
    <?php include('navmenu.php'); ?>
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-dashboard"></i> Download E Book</h1>
          </div>
          <div>
            <ul class="breadcrumb">
                  ...
                  <table id="file" class="table striped">
                    <thead class="bg-primary">
                        <tr>
                          ...
                          <td><strong>Nama E Book</strong></td>
                          <td><strong>Nama E Book Enkripsi</strong></td>
                          <td><strong>Ukuran E Book</strong></td>
                        ...
                        <?php
                          ...
                          <tr>
                            ...
                            <td><?php if ($data['status'] == 1) {
                              echo "<a href='decrypt.php' class='btn btn-success'>Terkunci</a>";
